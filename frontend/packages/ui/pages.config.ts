  ...
  pages: [
    {
      ...
      style: { navigationBarTitleText: '智能健康仪表盘' }
    },
    {
      path: 'pages/diary/index',
      style: { navigationBarTitleText: '饮食日记' }
    },
    {
      path: 'pages/scan/index',
      style: { navigationBarTitleText: '拍照识别', navigationStyle: 'custom' }
    },
    {
      path: 'pages/wiki/index',
      style: { navigationBarTitleText: '食材百科' }
    },
    {
    ...
    },
    {
      ...
      style: { navigationBarTitleText: '成就' }
    },
    {

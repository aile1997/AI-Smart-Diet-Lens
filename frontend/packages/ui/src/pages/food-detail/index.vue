  ...
  <view class="relative min-h-screen w-full flex flex-col bg-[#F5F7FA]">
    ...
    <view class="relative h-[380px] w-full shrink-0">
      ...
      <view class="absolute top-0 left-0 w-full p-6 pt-14 flex justify-between items-center text-white z-20">
        <view
          @tap="navigateBack"
          class="bg-white/20 backdrop-blur-md w-10 h-10 flex items-center justify-center rounded-full active:bg-white/30 transition active:scale-95 border border-white/10"
        >
    ...
    <!-- Content Section -->
    <view class="relative -mt-12 bg-[#F5F7FA] rounded-t-3xl px-6 pt-8 pb-28 z-10 shadow-[0_-10px_40px_rgba(0,0,0,0.05)]">
      <!-- Title & Score -->
      <view class="flex justify-between items-start mb-8">
        ...
        <!-- AI Score Card -->
        <view
          class="flex flex-col items-center justify-center bg-white rounded-2xl shadow-sm p-3 border border-gray-100 w-[84px] h-[100px] shrink-0 relative overflow-hidden"
        >
          ...
          <view class="flex gap-4 pb-4">
            <view v-for="(item, index) in pairings" :key="index" @tap="addPairing(item)" class="shrink-0 w-36">
              <view class="w-36 h-36 rounded-2xl overflow-hidden mb-2 relative shadow-sm border border-gray-100">
                ...
                <view
                  class="absolute bottom-2 right-2 w-7 h-7 bg-white/90 backdrop-blur rounded-full flex items-center justify-center shadow-sm text-[#34C759]"
                >

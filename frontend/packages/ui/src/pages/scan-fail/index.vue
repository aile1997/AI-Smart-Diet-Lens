  ...
  <view class="h-screen w-full flex flex-col bg-[#F6F8F7]">
    ...
    <view class="flex-1 flex flex-col items-center justify-center px-6 pb-24 relative">
      ...
      <view class="relative w-full aspect-square max-w-[320px] mb-8 flex items-center justify-center">
        ...
        <view class="relative z-10 w-full h-full rounded-2xl overflow-hidden bg-white/50 dark:bg-white/5 backdrop-blur-sm border border-white/20 dark:border-white/10 flex items-center justify-center">
          <!-- Blurred food image -->
          <image
            src="https://lh3.googleusercontent.com/aida-public/AB6AXuA87bwqPW-Nculixr2de8AkFxocPTDgmOwhXxY5Mi7TIIcOHei4G2BUZIDdoySMmJAy2AUHm2iP4C0xGSVx_UHvrx0pNDymLio8_7tjxGYMfztcisRPm_BIpVlge5SksLARB8s9toZqX6vcf88z0INLOHq1lrWIqfygczQOJllym27MRG9ihDGRRF4tBeoD3fKTFaMTVbnZzNyO1zfkyQjaoR3ER_Jup5KH3G9gDUXRRih6yQHYHJZiysvGKAvoKod9itVKyXoLpY49"
        ...
        <view class="absolute -bottom-4 bg-white dark:bg-gray-800 p-4 rounded-full shadow-lg border border-gray-100 dark:border-gray-700 flex items-center justify-center z-20">
          <text class="material-symbols-outlined text-[#38e07b] text-[32px]">broken_image</text>
        </view>
      </view>

      <!-- Status Message -->
      <view class="text-center space-y-3 max-w-[280px]">
        <text class="text-2xl font-extrabold tracking-tight text-[#0e1a13] dark:text-white">
          识别失败
        </text>
        <text class="text-base font-medium text-[#5c6f62] dark:text-[#a3b8aa] leading-relaxed">
    ...
    <view class="fixed bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-[#F6F8F7] via-[#F6F8F7] to-transparent pb-8">
      <view class="flex flex-col gap-3 max-w-md mx-auto w-full">
        ...
        >
          <text class="material-symbols-outlined mr-2 text-[#0e1a13] text-[20px] group-hover:scale-110 transition-transform">edit_note</text>
        ...
        >
          <text class="material-symbols-outlined mr-2 text-[20px]">cached</text>
